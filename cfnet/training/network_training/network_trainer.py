...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        if 'cfnet_use_progress_bar' in os.environ.keys():
            self.use_progress_bar = bool(int(os.environ['cfnet_use_progress_bar']))
    ...
    def plot_network_architecture(self):
        """
        can be implemented (see CFNetTrainer) but does not have to. Not implemented here because it imposes stronger
