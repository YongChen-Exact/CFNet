...
import matplotlib
from cfnet.postprocessing.connected_components import determine_postprocessing
from cfnet.training.data_augmentation.default_data_augmentation import get_default_augmentation
from cfnet.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset
from cfnet.evaluation.evaluator import aggregate_scores
from cfnet.training.network_training.CFNetTrainer import CFNetTrainer
from cfnet.network_architecture.neural_network import SegmentationNetwork
from cfnet.paths import network_training_output_dir
from cfnet.inference.segmentation_export import save_segmentation_nifti_from_softmax
from batchgenerators.utilities.file_and_folder_operations import *
import numpy as np
from cfnet.utilities.one_hot_encoding import to_one_hot
import shutil

matplotlib.use("agg")


class CFNetTrainerCascadeFullRes(CFNetTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="CFNetTrainer", fp16=False):
        super(CFNetTrainerCascadeFullRes, self).__init__(plans_file, fold, output_folder, dataset_directory,
    ...
    def do_split(self):
        super(CFNetTrainerCascadeFullRes, self).do_split()
    ...
    def process_plans(self, plans):
        super(CFNetTrainerCascadeFullRes, self).process_plans(plans)
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        if run_postprocessing_on_folds:
            # in the old cfnet we would stop here. Now we add a postprocessing. This postprocessing can remove everything
