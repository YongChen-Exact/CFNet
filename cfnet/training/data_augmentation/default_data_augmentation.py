...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'CFNet_n_proc_DA' not in os.environ else int(os.environ['CFNet_n_proc_DA']),
...
if __name__ == "__main__":
    from cfnet.training.dataloading.dataset_loading import DataLoader3D, load_dataset
    from cfnet.paths import preprocessing_output_dir
    import os
    import pickle
