...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, CFNetTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "CFNetTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, CFNetTrainer), "network_trainer was found but is not derived from " \
                                                         "CFNetTrainer"
