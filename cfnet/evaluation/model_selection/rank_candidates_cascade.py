...
if __name__ == "__main__":
    ...
    plans = "CFNetPlansv2.1"

    overwrite_plans = {
        'CFNetTrainerCascadeFullRes': ['CFNetPlans'],
    }

    trainers = [
        'CFNetTrainerCascadeFullRes',
        'CFNetTrainerV2CascadeFullRes_EducatedGuess',
        'CFNetTrainerV2CascadeFullRes_EducatedGuess2',
        'CFNetTrainerV2CascadeFullRes_EducatedGuess3',
        'CFNetTrainerV2CascadeFullRes_lowerLR',
        'CFNetTrainerV2CascadeFullRes',
        'CFNetTrainerV2CascadeFullRes_noConnComp',
        'CFNetTrainerV2CascadeFullRes_shorter_lowerLR',
        'CFNetTrainerV2CascadeFullRes_shorter',
        'CFNetTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
