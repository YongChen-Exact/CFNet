...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'CFNetTrainerV2_2': ["CFNetPlans", "CFNetPlans_customClip"], # r
        'CFNetTrainerV2_2_noMirror': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_lessMomentum_noMirror': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_2_structSeg_noMirror': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_2_structSeg': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_lessMomentum_noMirror_structSeg': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_FabiansResUNet_structSet_NoMirror': ["CFNetPlans", "CFNetPlans_customClip"],  # r
        'CFNetTrainerV2_FabiansResUNet_structSet': ["CFNetPlans", "CFNetPlans_customClip"],  # r

    }

    trainers = ['CFNetTrainer'] + [
        'CFNetTrainerV2_2',
        'CFNetTrainerV2_lessMomentum_noMirror',
        'CFNetTrainerV2_2_noMirror',
        'CFNetTrainerV2_2_structSeg_noMirror',
        'CFNetTrainerV2_2_structSeg',
        'CFNetTrainerV2_lessMomentum_noMirror_structSeg',
        'CFNetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'CFNetTrainerV2_FabiansResUNet_structSet_NoMirror',
        'CFNetTrainerV2_FabiansResUNet_structSet',
    ]
