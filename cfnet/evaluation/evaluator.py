...
from cfnet.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
if __name__ == '__main__':
    training_output_folder1 = "G:/CY\CodesOfCy/new/CFNet-main/DATASET/CFNet_trained_models/CFNet/3d_fullres/Task001_ACDC/CFNetTrainerV2_cfnet_acdc__CFNetPlansv2.1"
    plans = load_pickle(join(training_output_folder1, "plans.pkl"))
    output_folder = "G:/CY/CodesOfCy/new/CFNet-main/DATASET/CFNet_trained_models/CFNet/ensembles/Task001_ACDC/ensemble_3d_fullres__CFNetTrainerV2_cfnet_acdc__CFNetPlansv2.1--3d_fullres__CFNetTrainerV2_cfnet_acdc__CFNetPlansv2.1"
    ...
    out_files=[]
    gt_segmentations=[]
    folder_with_gt_segs = "G:/CY/CodesOfCy/new/CFNet-main/DATASET/CFNet_raw/CFNet_raw_data/Task01_ACDC/labelsTr"
