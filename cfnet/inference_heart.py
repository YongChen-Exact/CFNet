...
def t():
    label_list = sorted(glob.glob(os.path.join(
        r"G:/CY/CodesOfCy/new/CFNet-main/DATASET/CFNet_raw/CFNet_raw_data/Task05_Heart/labelsTs",
        '*nii.gz')))
    dest_file = r"G:\CY\CodesOfCy\new\CFNet-main\DATASET\CFNet_trained_models\CFNet\3d_fullres\Task005_Heart\CFNetTrainerV2_cfnet_heart__CFNetPlansv2.1\fold_0\model_best"
    infer_list = sorted(
