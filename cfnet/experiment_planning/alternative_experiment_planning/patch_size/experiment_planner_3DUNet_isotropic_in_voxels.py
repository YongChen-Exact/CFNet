...
import numpy as np
from cfnet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from cfnet.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
...
class ExperimentPlanner3D_IsoPatchesInVoxels(ExperimentPlanner):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "CFNetData_isoPatchesInVoxels"
        self.plans_fname = join(self.preprocessed_output_folder, "CFNetPlans" + "fixedisoPatchesInVoxels_plans_3D.pkl")
